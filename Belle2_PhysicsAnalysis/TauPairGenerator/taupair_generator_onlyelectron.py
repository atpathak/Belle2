...
kkgeninput.param('taudecaytableFile', './my_tau_decaytable_2.dat')
kkgeninput.param('kkmcoutputfilename', 'kkmc_tautau_2.txt')

# run
main.add_module("Progress")
main.add_module(kkgeninput)
main.add_module("RootOutput", outputFileName="kkmc_tautau_2.root")
...
infile = ROOT.TFile("Generator_2.root","recreate")
