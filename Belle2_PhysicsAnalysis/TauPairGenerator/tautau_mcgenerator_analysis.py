...
#ma.cutAndCopyLists('e-:good', 'e-:all', '', path=my_path)
...
#ma.reconstructDecay('tau-:gen -> e-:gen', '', path=my_path)
#ma.reconstructDecay('tau+:all -> e+:gen', ' charge == 1', path=my_path)
#decay_chain = 'vpho -> [^tau- -> ^e-] [^tau+ -> ^e+]'
