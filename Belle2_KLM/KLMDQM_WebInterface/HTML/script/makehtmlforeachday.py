...
'''
    ...
    for i in run:
        ...
        Main +=r'''<h3 class="bottom-medium"> BKLM Plots for run '''+i+''': </h3>
        <h4 class="bottom-small" style="margin-left:30px;"> <a href="./r0'''+i+'''/png-e0008r0'''+i+'''/RawKLMs/index.html"> RawKLM </a> </h4>
        <h4 class="bottom-small" style="margin-left:30px;"> <a href="./r0'''+i+'''/png-e0008r0'''+i+'''/mappedSectoroccupancy/index.html"> Sector occupancy  </a> </h4>
        <h4 class="bottom-small" style="margin-left:30px;"> <a href="./r0'''+i+'''/png-e0008r0'''+i+'''/mappedRPCTime/index.html"> RPC time  </a> </h4>
        <h4 class="bottom-small" style="margin-left:30px;"> <a href="./r0'''+i+'''/png-e0008r0'''+i+'''/mappedScintCtime/index.html"> Scint time </a> </h4>
        <h4 class="bottom-small" style="margin-left:30px;"> <a href="./r0'''+i+'''/png-e0008r0'''+i+'''/RPC_occupancy/index.html"> Occupancy (x/y view) </a> </h4>
        <h4 class="bottom-small" style="margin-left:30px;"> <a href="./r0'''+i+'''/hitmap-e0008r0'''+i+'''/Planez/index.html"> z hits by sector </a> </h4>
        <h4 class="bottom-small" style="margin-left:30px;"> <a href="./r0'''+i+'''/hitmap-e0008r0'''+i+'''/PlanePhi/index.html"> phi hits by sector </a> </h4>
        <hr> \n
'''
