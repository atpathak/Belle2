...
'''
    ...
    \includegraphics[width=.20\textwidth,height=.25\textheight,type=png,ext=.png,read=.png]{/ghi/fs01/belle2/bdata/group/detector/BKLM/Run_Analysis/e%(exp)s/bklmroots/r%(run)s/png-e%(exp)sr%(run)s/occupancyForwardXYBkgd}
    ...
    \includegraphics[width=.20\textwidth,height=.25\textheight,type=png,ext=.png,read=.png]{/ghi/fs01/belle2/bdata/group/detector/BKLM/Run_Analysis/e%(exp)s/bklmroots/r%(run)s/png-e%(exp)sr%(run)s/occupancyBackwardXYBkgd}
