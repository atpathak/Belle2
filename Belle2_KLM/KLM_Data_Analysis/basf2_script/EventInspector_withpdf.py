...
class EventInspector(basf2.Module):
    ...
    def terminate(self):
        ...
        # --------- adding by me -------------------
        self.hist_occupancyBackwardXYPromptBkgd.Draw("colz")
        canvas.Print(self.pdfName, "Title:{0}".format(self.hist_occupancyBackwardXYPromptBkgd.GetName()))
        self.hist_occupancyForwardXYPromptBkgd.Draw("colz")
        canvas.Print(self.pdfName, "Title:{0}".format(self.hist_occupancyForwardXYPromptBkgd.GetName()))
        #------------ up to this----------------
