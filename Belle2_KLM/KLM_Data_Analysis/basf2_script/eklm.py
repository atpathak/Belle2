...
if int(exp) == 7: # odd experiment number for physics collisions
    ...
    inputName = '/group/belle2/dataprod/Data/Raw/e0007/r{1}/sub00/*.{0}.{1}.{2}.f*.root'.format(exp, run, HLT)


if int(exp) == 8: # odd experiment number for physics collisions
    #inputName = '/home/belle2/atpathak/ppcc2018/work/myHead/r03123/sub00/*.{0}.{1}.HLT*.f*.root'.format(exp, run)
    inputName = '/group/belle2/dataprod/Data/Raw/e0008/r{1}/sub00/*.{0}.{1}.{2}.f*.root'.format(exp, run, HLT)

if int(exp) == 9: # odd experiment number for physics collisions
    #inputName = '/home/belle2/atpathak/ppcc2018/work/myHead/r03123/sub00/*.{0}.{1}.HLT*.f*.root'.format(exp, run)
    inputName = '/group/belle2/dataprod/Data/Raw/e0009/r{1}/sub00/*.{0}.{1}.{2}.f*.root'.format(exp, run, HLT)
    
if int(exp) == 10: # odd experiment number for physics collisions
    #inputName = '/home/belle2/atpathak/ppcc2018/work/myHead/r03123/sub00/*.{0}.{1}.HLT*.f*.root'.format(exp, run)
    inputName = '/group/belle2/dataprod/Data/Raw/e0010/r{1}/sub00/*.{0}.{1}.{2}.f*.root'.format(exp, run, HLT)

print(inputName)

outputName = 'eklm-e{0}r{1}_{2}.root'.format(exp, run, HLT)
histName = '/ghi/fs01/belle2/bdata/group/detector/BKLM/Run_Analysis/e{0}/bklmroots/r{1}/eklmHists-e{0}r{1}_{2}.root'.format(exp, run, HLT)
