...
elif int(exp) == 5: # new cosmic runs
    prefix = '/group/belle/users/stottler/bklm/localRuns/root/rawFiles/'
    if int(run) == 32:
        seqInputNames = [ prefix + 'stottler_aux_run32_scrodFirmware181106.sroot' ]
    if int(run) == 33:
...
histName = 'bklmHists-e{0}r{1}_{2}.root'.format(exp, run, HLT)
#histName = '/ghi/fs01/belle2/bdata/group/detector/BKLM/Run_Analysis/e{0}/bklmroots/r{1}/bklmHists-e{0}r{1}_{2}.root'.format(exp, run, HLT)
